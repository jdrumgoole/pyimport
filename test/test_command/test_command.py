...
class Test(unittest.TestCase):
    ...
    def test_generate_field_file_Command(self):
        cmd = GenerateFieldfileCommand()
        shutil.copy("yellow_trip_data_10.csv",
                    "test_generate.csv")
        cmd.run("test_generate.csv")
        self.assertTrue(os.path.isfile("test_generate.tff"))
        os.unlink("test_generate.tff")
        os.unlink("test_generate.csv")
